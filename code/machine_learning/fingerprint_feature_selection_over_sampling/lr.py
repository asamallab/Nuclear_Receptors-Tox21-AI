""" Fingerprint-based classification using Logistic Regression with SMOTE balancing and 10-fold Stratified Cross-Validation.
...
param_grid = {
    "lr__C": [
        ...
        0.6, 0.7, 0.8, 0.9,
        1, 2, 3, 4, 5,
        7, 9, 11, 15, 20, 25, 30, 35, 40, 50, 100
    ],
    "lr__penalty": ["l1", "l2"],
