""" Fingerprint-based classification using Random Forest, SMOTE balancing, and 10-fold Stratified CV"""
...
from sklearn.metrics import (
    ...
    matthews_corrcoef, roc_auc_score, confusion_matrix,average_precision_score
)
import pickle
...
pipeline = Pipeline([
    ...
    ('rf', RandomForestClassifier(random_state=SEED, n_jobs=n_jobs_rf))
])
