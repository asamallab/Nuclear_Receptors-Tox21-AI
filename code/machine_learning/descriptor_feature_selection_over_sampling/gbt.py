""" Descriptor-based classification using Gradient Boost with SMOTE balancing and 10-fold Stratified Cross-Validation.
...
# PARAM GRID
param_grid = {
    'gbt__learning_rate': [0.001, 0.005, 0.01, 0.05, 0.1],
    'gbt__n_estimators': [5, 10, 50, 100, 130],
    'gbt__max_depth': [1, 2, 3, 4],
}
