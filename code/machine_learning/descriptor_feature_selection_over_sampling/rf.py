""" Descriptor-based classification using Random Forest with SMOTE balancing and 10-fold Stratified Cross-Validation.
...
# PARAM GRID
param_grid = {
    "model__n_estimators": [3, 5, 10, 15, 20, 30, 50, 90, 95, 100, 125, 130, 150],
